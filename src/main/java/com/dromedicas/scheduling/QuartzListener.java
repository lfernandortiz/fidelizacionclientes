...
public class QuartzListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent servletContext) {
		try {
//			
//			//Tool for generating cron expressions (http://www.cronmaker.com/)
//			
//			/*
...
//					.withSchedule(CronScheduleBuilder.cronSchedule("0 0/20 * 1/1 * ? *")) //cada 30 min
//					.build();
//			
//			// configuracion del Setup the Job and Trigger with Scheduler & schedule jobs
...
//			schTxPuntosF.scheduleJob(jobTx, triggerTx);
			...
			Trigger triggerEmailR = newTrigger().withIdentity("EmailRechazados", "EmailGroup")
					.withSchedule(CronScheduleBuilder.cronSchedule("0 0/10 * 1/1 * ? *")) //Cada 6 Horas 0 0 0/6 1/1 * ? *
					.build();			
...
//					.withSchedule(CronScheduleBuilder.cronSchedule("0 0 6 1/1 * ? *")) // Todos los dias a las 6AM  0 0 6 ? * MON-SUN *
//					.build();
//
//			
